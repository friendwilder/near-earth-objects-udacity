...
class NearEarthObject:
    ...
    def __init__(self, **info):
        ...
        self.name = info['name'] if info['name'] is not '' else None # None
    ...
    def __str__(self):
        ...
        return (f"A NearEarthObject {self.fullname} has a diameter of {self.diameter:.3f} km "
                f"and is {self.hazardous} potentially hazardous")
...
class CloseApproach:
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return (f"At {datetime_to_str(self.time)}, {self._designation} approaches Earth at a distance of {self.distance:.2f}"
